...
void main()
{
  ...
  for(;;) { 
    ...
    drawString5x7(1,1, "P2 Score:", COLOR_GREEN, COLOR_BLUE);
    drawString5x7(1,152, "P1 Score:", COLOR_GREEN, COLOR_BLUE);
    drawString5x7(70,152, p1ScoreString, COLOR_GREEN, COLOR_BLUE);
    drawString5x7(70,1, p2ScoreString, COLOR_GREEN, COLOR_BLUE);
